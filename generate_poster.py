...
def _score_article(title: str, summary: str, source: str = "", article: dict | None = None) -> int:
    ...
    _HARD_NEWS_INDICATORS = [
        ...
        "处罚", "没收", "罚没", "取缔", "关停", "拆除",
        # 经济/金融动作
        "签署", "协议", "合作", "投资", "融资", "上市", "破产", "倒闭",
        "裁员", "收购", "合并", "降息", "降准", "加息", "增发", "发行",
        "亏损", "盈利", "涨停", "跌停", "退市",
        # 天气/自然灾害
        "暴雨", "洪水", "地震", "台风", "干旱", "高温", "寒潮", "暴雪",
        "泥石流", "山体滑坡", "内涝", "预警",
        # 基建/工程
        "开通", "运行", "投产", "交付", "竣工", "开工", "建成", "启用",
        "发射", "通航", "试飞",
        # 社会/民生
        "接种", "疫苗", "感染", "确诊", "病例", "隔离",
        "停电", "停水", "中断", "瘫痪",
        ...
        "破获", "抓获", "打掉", "捣毁", "抓捕", "追逃",
        # 国际/外交
        "选举", "当选", "就任", "辞职", "卸任", "访问", "会见", "会晤", "会谈",
        "冲突", "交火", "空袭", "袭击", "恐袭", "入侵", "撤退", "停火",
        "制裁", "封锁", "禁运", "军演", "军援",
        # 数据/指标
        "增长", "下降", "上升", "减少", "增加", "突破", "创", "破",
    ]
...
def _classify_by_title(title: str, default_scope: str, default_category: str) -> tuple[str, str]:
    ...
    intl_keywords = [
        ...
        "委内瑞拉", "巴西", "阿根廷", "墨西哥", "古巴", "哥伦比亚", "智利", "秘鲁",

        "英国", "法国", "德国", "意大利", "西班牙", "荷兰", "瑞士", "瑞典",

        "加拿大", "澳大利亚", "新西兰", "南非", "埃及", "尼日利亚",
